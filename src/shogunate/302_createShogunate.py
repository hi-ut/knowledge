...
t = "https://w3id.org/hi/api/term/type/Shogunate"

subject = URIRef(t)

stmt = (subject, URIRef("http://www.w3.org/2000/01/rdf-schema#label"), Literal("Shogunate"))
...
path = t.replace("https://w3id.org/hi", "../docs")+".json"
...
with open('data/sho.csv', 'r') as f:
    ...
    for row in reader:
        ...
        id = "https://w3id.org/hi/api/entity/shogunate/" + label
        ...
        path = id.replace("https://w3id.org/hi", "../docs")+".json"
