...
for sheetname in sheets:
    ...
    for i in range(1, len(values)):
        ...
        s = "https://w3id.org/hi/api/term/蔵人所/" + label
        ...
        all.add((s, RDF.type, URIRef("https://w3id.org/hi/api/term/type/蔵人所")))
        all.add((s, URIRef("http://www.w3.org/2004/02/skos/core#closeMatch"), URIRef(ikai)))

# print(all)
all.serialize(destination="data/ku.rdf", format='pretty-xml')
