...
t = "https://w3id.org/hi/api/term/type/Person"
...
for file in files:
    ...
    id = "https://w3id.org/hi/api/entity/chname/" + filename
    ...
    path = id.replace("https://w3id.org/hi", "../docs")
...
f2 = open(path, 'w')
json.dump(arr, f2, ensure_ascii=False, indent=4,
            sort_keys=True, separators=(',', ': '))
